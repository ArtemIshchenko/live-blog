...
@section('content')
<style>
    .form-check label, .form-check input {position: static;}
</style>
<div class="container">
            ...
            <div class="card" style="position: static;">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="gender" class="col-md-4 form-check-label text-md-right">{{ __('Пол') }}</label>
                            <div class="form-check col-md-2">
                                <input class="form-check-input" type="radio" name="gender" value="0" id="gender_men" checked>
                                <label for="gender_men" class="form-check-label">{{ __('Мужской') }}</label>
                            </div>

                            <div class="form-check col-md-2">
                                <input class="form-check-input" type="radio" name="gender" value="1"  id="gender_women">
                                <label for="gender_women" class="form-check-label">{{ __('Женский') }}</label>
                            </div>
                        </div>
